...
scContentEditor.prototype.addSearchCriteria = function (sender, evt) {
    ...
    cell.innerHTML = "<div class='scElementHover elementPadding'><a href=\"#\" class=\"scSearchOptionName searchOptionAlignment\" onclick=\"javascript:return scForm.postEvent(this,event,'TreeSearchOptionName_Click',true)\">" + name + " <img src='/sitecore/shell/themes/standard/Images/down_h.png' class='arrowDown' /></a></div>"; //sitecore.support.108397
...
scContentEditor.prototype.changeSearchCriteria = function (index, name) {
    ...
    var searchOptionsName = table.rows[parseInt(index, 10)].cells[0].firstElementChild.firstElementChild; //sitecore.support.108397
    ...
    if (searchOptionsName && searchOptionsValue) {
        ...
        searchOptionsName.innerHTML = name + " <img src='/sitecore/shell/themes/standard/Images/down_h.png' class='arrowDown' />"; //sitecore.support.108397
...
scContentEditor.prototype.updateSearchCriteria = function () {
    ...
    for (var r = 0; r < table.rows.length - 1; r++) {
        ...
        cell.firstElementChild.firstElementChild.id = "SearchOptionsControl" + r; //sitecore.support.108397
